NEBLogin:
https://akveo.github.io/nebular/docs/auth/configuring-a-strategy#configure-a-strategy
Protecting application routes:
https://akveo.github.io/nebular/docs/auth/protecting-application-routes#protecting-application-based-on-user-authentication
...
https://pretagteam.com/question/how-can-i-add-the-jwt-authentication-in-ngxadmin
...
1.Add Folder Products
2.ng g c products/product-list
3.ng g c products/product-card
4.ng g m products/product
5.imports ProductModule in PagesModule
6.product-routing.module.ts->pages-routing.module.ts->pages-menu.ts->app-routing.module.ts
7.add product-routing.module.ts
8.add product.component.ts  pages/product/products
9.Add URL to enviroments/env
10. Add public/static to angular.json
11.cd src/app/pages ng g c products/coverlist
12. align button -> ProductCardComponent 
13.How To Use Query Parameters with Angular Router Angular
https://www.digitalocean.com/community/tutorials/angular-query-parameters
14. TODO Dark Theme
15. ng g c products/product-detail
16. add FormsModule, ReactiveFormsModule to productModule
17. getProduct to productService
18. productCode <- roterLink Parameter : private activatedRoute: ActivatedRoute;
19. forms :https://angular.io/guide/reactive-forms
20. Buttons
21. cd src/app/pages  ;  ng g c products/create-policy ; add product-routing.module.ts  ; private activatedRoute: ActivatedRoute,
22. cd src/app/pages  ;  ng g c products/policy-detail ; add product-routing.module.ts  ; private activatedRoute: ActivatedRoute,